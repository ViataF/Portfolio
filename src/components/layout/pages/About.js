      ...
      <div className="timeline center">
        <div className="card timeline-content">
          ...
          <div className="card-reveal">
            <span className="card-title company">
              {" "}
              <i className="material-icons right">close</i> {""}Education
            </span>
            <p className="content">
        ...
        <div className="card timeline-content activator">
          ...
          <div className="card-reveal">
            <span className="card-title company">
              <i className="material-icons right">close</i>
              {""}
              <p>Company: Parkhaven Senior citizen (Wynberg) Period: 2018</p>
            </span>
            ...
            <span className="card-title company">
              <p> Company: PlumPets Period: 2018</p>
            </span>
            <ul>
              Duties(PlumPets):
